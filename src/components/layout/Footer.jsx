    ...
    <footer className='relative bg-black overflow-hidden border-t border-white/10'>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-12 mb-12'>
                                ...
                                <li key={link.id}>
                                    <button onClick={() => scrollToSection(link.id)}
                                        className='group flex items-center gap-2 text-white/60 hover:text-primary transition-all duration-300'>
                                            <div className='w-1.5 h-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:w-2 transiton-all duration-300'/>
                ...
                <FadeIn delay={200}>
                    <div>
                        <h4 className='text-whtie font-semibold mb-6 text-lg'>Connect With Me</h4>
                        <p className='text-white/60 text-sm mb-6 leading-relaxed'>
                            Let's connect and create something amaxing together.
                        </p>
