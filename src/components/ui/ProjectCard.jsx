        ...
        <div className='absolute bottom-4 right-4 flex items-center gap-3'>
          {demoUrl && (
            <a 
              ...
              className='p-2.5 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 hover:bg-primary/30 hover:border-primary/50 transition-all duration-300 hover:'
              title='View Demo'
              >
          ...
          {githubUrl && (
            <a 
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='p-2.5 bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:bg-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-110'
                title='View Code'>
      ...
      <div className='p-6 space-y-4'>
        ...
        <div className='flex flex-wrap gap-2'>
          {technologies.map((tech, index)=> (
            <span key={index} className='px-3 py-1 text-sm font-medium text-primary bg-primary/10 border border-primary/20 rounded-lg hover:bg-primary/20 transition-colors duration-200'>
              {tech}
            </span>
          ))}
        </div>
