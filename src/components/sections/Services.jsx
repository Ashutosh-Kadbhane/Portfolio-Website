...
const Services = () => {
  return <section id='services' className='relative py-20 bg-black overflow-hidden'>
        ...
        <div className='absolute inset-0 opacity-[0.03]' style={{backgroundImage: `linear-gradient(to right, white 1px, transparent 1px),
        linear-gradient(to bottom, white 1px, transparent 1px)`,backgroundSize: '30px 30px'}}/>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <FadeIn delay={0}>
                <div className='text-center mb-16'>
                    ...
                    <h2 className='text-4xl lg:text-5xl font-medium text-white mb-4 max-w-2xl mx-auto'>
                ...
                {servicesData.slice(0,2).map((service, index) => {
                    ...
                    return(
                        <FadeIn key={service.id} delay={100 + index * 100}>
                            <div className='group relative bg-white/5 border border-white/20 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col'>
                                <div className='mb-6'>
