...
import {SiReact,  SiTailwindcss, SiNodedotjs, SiMongodb, SiJavascript, SiBootstrap} from 'react-icons/si';
...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-black ">
            ...
            <FadeIn delay={400}>
              ...
              {/* Right Column - Developer Image */}
                ...
                <FadeIn delay={200}>
                  ...
                  {/* Image Container */}
                  <div className="relative rounded-2xl overflow-hidden m-[1-x] h-[calc(100%-2px)]">
                  ...
                  {/* Technology Logos */}
                  <div className="absolute bottom-6 left-t z-20">
                    <FadeIn delay={500}>
      ...
      <button className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce" onClick={() => scrollToSection('about')}>
