...
import { Briefcase, Sparkles,  Globe, Palette, Zap, ChevronLeft, ChevronRight, Target} from 'lucide-react';
            ...
            <FadeIn delay={100}>
                <div className='flex flex-wrap justify-center gap-3 mb-16'>
                    {categories.map((category) => (
                        <button key={category}
                        onClick={() => handleCategoryChange(category)} className={`group relative px-6 py-3 rounded-full font-medium transition-all duration-300 ${activeCategory === category ? 'text-white'
