...
import { SiJavascript, SiReact, SiTailwindcss, SiNodedotjs, SiMongodb, SiHtml5, SiExpress, SiRedux, SiCss, SiMysql } from "react-icons/si";
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                    ...
                    <p className="text-sm text-white/70 leading-relaxed">Writing maintainable, well-documented code that is scalable.</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                    ...
                    <p className="text-sm text-white/70 leading-relaxed">
                      Optimizing for speed and efficiency in every project completed.
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-4xl mx-auto">
                {skills.map((skill, index) => (
                  <div key={index} className="w-[140px] group relative bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all duration-300 hover:scale-105">
